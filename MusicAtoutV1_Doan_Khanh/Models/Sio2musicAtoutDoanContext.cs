...
public partial class Sio2musicAtoutDoanContext : DbContext
{
    public Sio2musicAtoutDoanContext()
    {
    }

    public Sio2musicAtoutDoanContext(DbContextOptions<Sio2musicAtoutDoanContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=MYMUSE\\SQLEXPRESS;Initial Catalog=SIO2MusicAtout_Ddoan;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdUtilisateur).HasName("PK__UTILISAT__5366DB19DF1D1D02");
